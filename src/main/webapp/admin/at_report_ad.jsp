	...
	<script>
	    ...
	    appControllers.controller('ListController',function($timeout,$scope,$routeParams,$location,AdInfo,$modal,PageInfo){
	    	...
	    	$scope.table = $('#table').dataTable( {
    			...
    			"data":[{ad_info_sq:1,regDate:'티셔츠',view_count:20,click_count:20,click_ratio:'10.4%',cpc:'100원',amount:1200},
    			        {ad_info_sq:1,regDate:'나이키신발',view_count:20,click_count:20,click_ratio:'10.4%',cpc:'100원',amount:234},
    			        {ad_info_sq:1,regDate:'나이키티셔츠',view_count:20,click_count:20,click_ratio:'10.4%',cpc:'100원',amount:100},
    			        {ad_info_sq:1,regDate:'신발',view_count:20,click_count:20,click_ratio:'10.4%',cpc:'100원',amount:100},
    			        {ad_info_sq:1,regDate:'농구화',view_count:20,click_count:20,click_ratio:'10.4%',cpc:'100원',amount:200}
    			        ]
	    	    ,
    			"columnDefs": [ 
		...
		<div class="panel-body">
			...
			<div style="float:right">
				...
				<div class="btn-group" style='float:right' role="group" aria-label="...">
  					<a type="button" class="btn btn-default" href="at_daily_ac.jsp">일별</a>
  					<a type="button" class="btn btn-default" href="at_month_ac.jsp">월별</a>
  					<a type="button" class="btn btn-default active" href="at_report_ad.jsp">광고별</a>
				</div>
			</div>
