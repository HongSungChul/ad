	...
	<script>
		...
		app.config(['$routeProvider',
       		  ...
       		  $routeProvider.
	       		...
	       		when('/ad_unit/:member_code/view',{ //view
	 		  		templateUrl:'part/view.html',
	 		  		controller:'ViewController'
	 		  	}).
	 		  	when('/ad_unit/new',{ //new
	 		  		templateUrl:'part/new.html',
	 		  		controller:'NewController'
	 		  	}).
	 		  	when('/ad_unit/:member_code/edit',{ //view
	    ...
	    appControllers.controller('PausingController',function($scope,$routeParams,$location,Member,$modal){
				...
				<table id="table" class="display" cellspacing="0" width="100%">
					...
					<tbody>
						<tr>
							...
							<td><button class='btn btn-primary' ng-click="onPausing()">광고중지</button></td>
							<td>어뷰징의심</td>
						</tr>
						<tr>
							<td>2001-02-02</td>
						...
						<tr>
							...
							<td>광고단위명</td>
							<td><button class='btn btn-primary'>확인</button></td>
							<td><button class='btn btn-danger' ng-click="onPausing()">광고노출</button></td>
							<td>어뷰징의심</td>
						</tr>
						<tr>
							<td>2001-02-02</td>
