...
<!-- End wrapper-->
	    		...
	    		fnRowCallback: function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
	    		  ...
	    		  "language": {
			        ...
			        "columnDefs": [
			   					...
			   					{"targets": 1,"data": "bid","render": function ( data, type, full, meta ) {
			   						return full.companyName+'('+full.userid+')';
			   					}},
			   					{"targets": 2,"data": "title"},
			   					{"targets": 3,"data": "adInfo","render": function ( data, type, full, meta ) {
			   						return '<img src="'+full.imgUri+'" width=30 height=30>';
			   					},"orderable": false},
			   					{"targets": 4,"data": "link","render": function ( data, type, full, meta ) {
			   						return data;
			   					}}
			   		         ]
	...
	<ul class="nav nav-tabs">
			<li role="presentation" class="active"><a href="adm.jsp">전체광고</a></li>
