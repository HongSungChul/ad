	...
	ObjectMapper mapper = new ObjectMapper();
	 ...
	 if(USERINFO==null)	{
		...
		app.run(function($rootScope,$http) {
			...
			$rootScope.title='매체사별 현황'; // 타이틀 베목
			$rootScope.newItem={};
	    ...
	    appControllers.controller('ListController',function($timeout,$scope,$routeParams,$location,AdInfo,$modal,PageInfo){
	    	...
	    	$scope.table = $('#table').dataTable( {
    			...
    			"data":[{companyName:'ldjfl(aaa)',ad_info_sq:1,regDate:'2015.11.01',view_count:20,click_count:20,click_ratio:'10.4%',cpc:'100원',amount:1200,amount1:44,amount2:44,amount3:44},
    			        {companyName:'ldjfl(aaa)',ad_info_sq:1,regDate:'2015.11.02',view_count:20,click_count:20,click_ratio:'10.4%',cpc:'100원',amount:234,amount1:44,amount2:44,amount3:44},
    			        {companyName:'ldjfl(aaa)',ad_info_sq:1,regDate:'2015.11.03',view_count:20,click_count:20,click_ratio:'10.4%',cpc:'100원',amount:100,amount1:44,amount2:44,amount3:44},
    			        {companyName:'ldjfl(aaa)',ad_info_sq:1,regDate:'2015.11.04',view_count:20,click_count:20,click_ratio:'10.4%',cpc:'100원',amount:100,amount1:44,amount2:44,amount3:44},
    			        {companyName:'ldjfl(aaa)',ad_info_sq:1,regDate:'2015.11.05',view_count:20,click_count:20,click_ratio:'10.4%',cpc:'100원',amount:200,amount1:44,amount2:44,amount3:44},
    			        {companyName:'ldjfl(aaa)',ad_info_sq:1,regDate:'2015.11.06',view_count:20,click_count:20,click_ratio:'10.4%',cpc:'100원',amount:40,amount1:44,amount2:44,amount3:44},
    			        {companyName:'ldjfl(aaa)',ad_info_sq:1,regDate:'2015.11.07',view_count:20,click_count:20,click_ratio:'10.4%',cpc:'100원',amount:30,amount1:44,amount2:44,amount3:44},
    			        {companyName:'ldjfl(aaa)',ad_info_sq:1,regDate:'2015.11.08',view_count:20,click_count:20,click_ratio:'10.4%',cpc:'100원',amount:24,amount1:44,amount2:44,amount3:44},
    			        {companyName:'ldjfl(aaa)',ad_info_sq:1,regDate:'2015.11.09',view_count:20,click_count:20,click_ratio:'10.4%',cpc:'100원',amount:34,amount1:44,amount2:44,amount3:44},
    			        {companyName:'ldjfl(aaa)',ad_info_sq:1,regDate:'2015.11.10',view_count:20,click_count:20,click_ratio:'10.4%',cpc:'100원',amount:33,amount1:44,amount2:44,amount3:44},
    			        {companyName:'ldjfl(aaa)',ad_info_sq:1,regDate:'2015.11.11',view_count:20,click_count:20,click_ratio:'10.4%',cpc:'100원',amount:11,amount1:44,amount2:44,amount3:44},
    			        {companyName:'ldjfl(aaa)',ad_info_sq:1,regDate:'2015.11.12',view_count:20,click_count:20,click_ratio:'10.4%',cpc:'100원',amount:44,amount1:44,amount2:44,amount3:44}
    			        ]
	    	    ,
    			"columnDefs": [ 
					
		            {"targets": 0,"data": "companyName"},
		            {"targets": 1,"data": "view_count"},
		            {"targets": 2,"data": "click_count"},
		            {"targets": 3,"data": "click_ratio"},
		            {"targets": 4,"data": "cpc"},
		            {"targets": 5,"data": "amount"},
		            {"targets": 6,"data": "amount1"},
		            {"targets": 7,"data": "amount2"},
		            {"targets": 8,"data": "amount3"}
