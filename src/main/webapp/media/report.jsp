...
<!-- End wrapper-->
	...
	<%
	 ...
	 if(USERINFO==null)	{
		...
		app.config(['$routeProvider',
       		  ...
       		  $routeProvider.
       		  	when('/daily_mc',{ // list
       		  		templateUrl:'part/daily_mc.html',
       		  		controller:'DailyMcController'
       		  	}).
       		 	when('/month_mc',{ // list
    		  		templateUrl:'part/month_mc.html',
    		  		controller:'MonthMcController'
    		  	}).
    		  	when('/report_ad_unit',{ // list
       		  		templateUrl:'part/report_ad_unit.html',
       		  		controller:'ReportAdUnitController'
       		  	}).
	 		  	otherwise({
	 		  		redirectTo:'/daily_mc'
	 		  	});
	    ...
	    appControllers.controller('DailyMcController',function($rootScope,$timeout,$scope,$routeParams,$location,$modal){
	    ...
	    appControllers.controller('MonthMcController',function($rootScope,$timeout,$scope,$routeParams,$location,$modal){
	    ...
	    appControllers.controller('ReportAdUnitController',function($rootScope,$timeout,$scope,$routeParams,$location,$modal){
	    	$rootScope.title='보고서-광고단위별'; // 타이틀 베목
	    	$scope.searchForm={};
	    	$scope.cb = function(start, end) {
	    		$scope.searchForm.startDate = start.format('YYYY-MM-DD');
				$scope.searchForm.endDate=end.format('YYYY-MM-DD');
	    	...
	    	$scope.table = $('#table').dataTable( {
    	        ...
    	        "serverSide": true,
    			"ajax": {
		        	url:'/ad/media/dailyMcGroupByAdUnit', // 록록전체
		        	method:'GET',
		        	data:function(d){
		        		//d.target="daily";
		        		//d.startDate = $scope.searchForm.startDate;
	...
	<script type='text/ng-template' id='part/daily_mc.html'>
		...
		<div class="panel-body">
			...
			<div style="float:right">
				...
				<div class="btn-group" style='float:right' role="group" aria-label="...">
  					<a type="button" class="btn btn-default active" ng-href="#/daily_mc">일별</a>
  					<a type="button" class="btn btn-default" ng-href="#/month_mc">월별</a>
  					<a type="button" class="btn btn-default" ng-href="#/report_ad_unit">광고단위별</a>
				</div>
			</div>
	...
	<script type='text/ng-template' id='part/month_mc.html'>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div style="float:right">
				...
				<div class="btn-group" style='float:right' role="group" aria-label="...">
  					<a type="button" class="btn btn-default" href="#/daily_mc">일별</a>
  					<a type="button" class="btn btn-default active" ng-href="#/month_mc">월별</a>
  					<a type="button" class="btn btn-default" ng-href="#/report_ad_unit">광고단위별</a>
				</div>
			</div>
			<div class="dataTable_wrapper">
...
<script type='text/ng-template' id='part/report_ad_unit.html'>
		...
		<div class="panel-body">
			...
			<div style="float:right">
				...
				<div class="btn-group" style='float:right' role="group" aria-label="...">
  					<a type="button" class="btn btn-default" href="#/daily_mc">일별</a>
  					<a type="button" class="btn btn-default" ng-href="#/month_mc">월별</a>
  					<a type="button" class="btn btn-default active" ng-href="#/report_ad_unit">광고단위별</a>
				</div>
			</div>
			<div class="dataTable_wrapper">
				<table id="table" class="display" cellspacing="0" width="100%">
