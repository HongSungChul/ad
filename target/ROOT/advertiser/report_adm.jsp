	...
	<%
	 ...
	 if(USERINFO==null)	{
		...
		app.config(['$routeProvider',
       		  ...
       		  $routeProvider.
       		  	when('/report_adm',{ // list
       		  		templateUrl:'part/list.html',
       		  		controller:'ListController'
       		  	}).
	       		when('/report_adm/:ad_info_sq/view',{ //view
	 		  	...
	 		  	when('/report_adm/new/1',{ //new
	 		  		templateUrl:'part/new1.html',
	 		  		controller:'New1Controller'
	 		  	}).
	 		  	when('/report_adm/:ad_info_sq/edit',{ //view
	 		  		template:'',
	 		  		controller:'EditController'
	 		  	}).
	 		  	otherwise({
	 		  		redirectTo:'/report_adm'
	 		  	});
		...
		<div class="panel-body">
			...
			<div class="dataTable_wrapper">
				<table id="table" class="display" cellspacing="0" width="100%">
					...
					<tfoot>
						<tr>
							<th class='text-center' style='vertical-align:middle'>합계</th>
							<th>0</th>
							<th>0</th>
							<th>0</th>
							<th>0</th>
