	...
	<%
	 ...
	 if(USERINFO==null)	{
	    		...
	    		fnRowCallback: function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
	    		  ...
	    		  "language": {
			        ...
			        "columnDefs": [
	   					...
	   					{"targets": 3,"data": "amount","render": function ( data, type, full, meta ) {
	   						return full.point+'/'+full.price;
	   					}},
	   					{"targets": 4,"data": "sortOrder","render": function ( data, type, full, meta ) {
	   						return data;
	   					}},
	   					{"targets": 5,"data": "btn","render": function ( data, type, full, meta ) {
	    ...
	    appServices.factory('Advertising',function($resource){
			...
			return $resource('/ad/advertiser/Advertising/:admSq/:kw1Sq/:kw2Sq', { admSq: '@admSq',kw1Sq: '@kw1Sq',kw2Sq: '@kw2Sq' }, {
				update:{ method:'PUT'},
