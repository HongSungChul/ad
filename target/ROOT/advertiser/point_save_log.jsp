	...
	<%
	 ...
	 if(USERINFO==null)	{
		...
		app.run(function($rootScope,$http) {
			...
			$rootScope.title='포인트적립내역'; // 타이틀 베목
			$rootScope.newItem={};
	    ...
	    appControllers.controller('ListController',function($timeout,$scope,$routeParams,$location,AdInfo,$modal,PageInfo){
	    	...
	    	$scope.table = $('#table').dataTable( {
    			...
    			"order": [],
    			"bSort":true,
    			"data":[{point_sq:1,save_type:'카드',point:10000,acpt_yn:'승인', description:'관리자 보너스 적립', regDate:'2015.0.10'},
    			        {point_sq:1,save_type:'무통장',point:10000,acpt_yn:'승인', description:'성공', regDate:'2015.0.10'},
    			        {point_sq:1,save_type:'보너스',point:10000,acpt_yn:'승인', description:'관리자 보너스 적립', regDate:'2015.0.10'},
    			        {point_sq:1,save_type:'보너스',point:10000,acpt_yn:'승인', description:'관리자 보너스 적립', regDate:'2015.0.10'},
    			        {point_sq:1,save_type:'보너스',point:10000,acpt_yn:'취소', description:'관리자 보너스 적립', regDate:'2015.0.10'},
    			        {point_sq:1,save_type:'보너스',point:10000,acpt_yn:'승인', description:'관리자 보너스 적립', regDate:'2015.0.10'},
    			        {point_sq:1,save_type:'보너스',point:10000,acpt_yn:'승인', description:'관리자 보너스 적립', regDate:'2015.0.10'}
    			        ]
	    	    ,
