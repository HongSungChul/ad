		...
		<div class="panel-body">
			...
			<div style="float:right">
				...
				<div class="btn-group" style='float:right' role="group" aria-label="...">
  					<a type="button" class="btn btn-default" href="daily_ac.jsp">일별</a>
  					<a type="button" class="btn btn-default" href="month_ac.jsp">월별</a>
  					<a type="button" class="btn btn-default active" href="report_ad.jsp">광고별</a>
				</div>
			</div>
