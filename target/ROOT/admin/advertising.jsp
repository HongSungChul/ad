...
<!-- End wrapper-->
	...
	ObjectMapper mapper = new ObjectMapper();
	 ...
	 if(USERINFO==null)	{
	    ...
	    appControllers.controller('ListController',function($scope,$routeParams,$location,Advertising,$modal){
	    		...
	    		fnRowCallback: function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
	    		  ...
	    		  "language": {
			        ...
			        "columnDefs": [
	   					...
	   					{"targets": 4,"data": "amount","render": function ( data, type, full, meta ) {
	   						return full.point+'/'+full.price;
	   					}},
	   					{"targets": 5,"data": "sortOrder","render": function ( data, type, full, meta ) {
	   						return data;
	   					}},
	   					{"targets": 6,"data": "btn","render": function ( data, type, full, meta ) {
	   						return '<button class="btn btn-danger">중지</button>';
	   					}}
			...
			$scope.onDelete=function(item){
				bootbox.confirm("정말로 삭제하시겠습니까?", function(result) {
					if(result){
						...
						Advertising.delete(item,function(res){
							if(res.success){
	    ...
	    appControllers.controller('ViewController',function($scope,$routeParams,$location,Advertising,$modal){
	    ...
	    appControllers.controller('NewController',function($scope,$routeParams,$location,Advertising,$modal){
	    ...
	    appControllers.controller('EditController',function($scope,$routeParams,$location,Advertising,$modal){
	    ...
	    appServices.factory('Advertising',function($resource){
			
			return $resource('/ad/admin/Advertising/:admSq/:kw1Sq/:kw2Sq', { admSq: '@admSq',kw1Sq: '@kw1Sq',kw2Sq: '@kw2Sq' }, {
				update:{ method:'PUT'},
	...
	<div class="panel panel-default">
		...
		<ul class="nav nav-tabs">
			...
			<li role="presentation" ><a href="bidding.jsp">입찰광고</a></li>			  
			<li role="presentation" class="active"><a href="advertising.jsp">집행광고</a></li>  
		</ul>
