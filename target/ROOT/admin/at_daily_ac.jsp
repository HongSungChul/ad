   ...
   <script src="//code.jquery.com/jquery-2.1.0.min.js"></script>
	...
	<script>
		...
		app.run(function($rootScope,$http) {
			$rootScope.title='광고별 집행보고'; // 타이틀 베목
			$rootScope.newItem={};
	    ...
	    appControllers.controller('ListController',function($timeout,$scope,$routeParams,$location,AdInfo,$modal,PageInfo){
	    	...
	    	$scope.table = $('#table').dataTable( {
    			...
    			"data":[{ad_info_sq:1,regDate:'2015.11.01',view_count:20,click_count:20,click_ratio:'10.4%',cpc:'100원',amount:1200},
    			        {ad_info_sq:1,regDate:'2015.11.02',view_count:20,click_count:20,click_ratio:'9.4%',cpc:'100원',amount:234},
    			        {ad_info_sq:1,regDate:'2015.11.03',view_count:20,click_count:20,click_ratio:'7.4%',cpc:'100원',amount:100},
    			        {ad_info_sq:1,regDate:'2015.11.04',view_count:20,click_count:20,click_ratio:'6.4%',cpc:'100원',amount:100},
    			        {ad_info_sq:1,regDate:'2015.11.05',view_count:20,click_count:20,click_ratio:'4.4%',cpc:'100원',amount:200},
    			        {ad_info_sq:1,regDate:'2015.11.06',view_count:20,click_count:20,click_ratio:'4.4%',cpc:'100원',amount:40},
    			        {ad_info_sq:1,regDate:'2015.11.07',view_count:20,click_count:20,click_ratio:'10.4%',cpc:'100원',amount:30},
    			        {ad_info_sq:1,regDate:'2015.11.08',view_count:20,click_count:20,click_ratio:'10.4%',cpc:'100원',amount:24},
    			        {ad_info_sq:1,regDate:'2015.11.09',view_count:20,click_count:20,click_ratio:'10.4%',cpc:'100원',amount:34},
    			        {ad_info_sq:1,regDate:'2015.11.10',view_count:20,click_count:20,click_ratio:'10.4%',cpc:'100원',amount:33},
    			        {ad_info_sq:1,regDate:'2015.11.11',view_count:20,click_count:20,click_ratio:'10.4%',cpc:'100원',amount:11},
    			        {ad_info_sq:1,regDate:'2015.11.112',view_count:20,click_count:20,click_ratio:'10.4%',cpc:'100원',amount:44}
    			        ]
	    	    ,
    			"columnDefs": [ 
		...
		<div class="panel-body">
			...
			<div style="float:right">
				...
				<div class="btn-group" style='float:right' role="group" aria-label="...">
  					<a type="button" class="btn btn-default active" href="at_daily_ac.jsp">일별</a>
  					<a type="button" class="btn btn-default" href="at_month_ac.jsp">월별</a>
  					<a type="button" class="btn btn-default" href="at_report_ad.jsp">광고별</a>
				</div>
			</div>
